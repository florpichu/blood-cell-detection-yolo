...
Proyecto de Laboratorio 6 (FCEyN, UBA) — el laboratorio de fin de carrera donde cada estudiante propone y desarrolla su propio proyecto experimental. Realizado en conjunto con Maximiliano Rodríguez Camps.
...
01_merge_dataset.ipynb — Creación del dataset: anotación manual de imágenes de frotis en Roboflow, generando tres versiones del dataset con distintas variaciones/aumentaciones, y unificación en un único dataset combinado (cuidando no duplicar imágenes repetidas entre versiones).
02_entrenamiento.ipynb — Entrenamiento de un modelo YOLOv8 sobre el dataset combinado, con evaluación de precision/recall por clase.
03_deteccion.ipynb — Pipeline de inferencia: al subir una imagen nueva, el modelo ya entrenado detecta y cuenta automáticamente cada tipo de célula presente.
Herramientas
